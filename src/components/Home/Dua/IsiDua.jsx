               ...
               <div className="containerTreasure">
                    ...
                    <div className="motto">
                        <div className="mottoLampung ">
                            ...
                            <p className="penjelasanMotto" data-aos="fade-left" data-aos-delay="200">Sang Bumi Ruwai Jurai merupakan motto dari provinsi Lampung, <br/> yang memiliki makna satu bumi dua tradisi (ruwa dan jurai). 
                        ...
                        <div className="treasure">
                            <h1 className="petikDua" data-aos="fade-right" data-aos-delay="900">❝ The Treasure of Sumatra ❞</h1>
                            <p className="penjelasanMotto" data-aos="fade-right" data-aos-delay="900">Lampung menggambarkan kekayaan alam dan budaya <br/> yang dimiliki oleh provinsi ini. Keindahan alamnya,
